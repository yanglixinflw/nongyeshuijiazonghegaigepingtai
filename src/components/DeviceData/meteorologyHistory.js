...
// 源columns拥有编号
const sourceColumns = [
    { title: "空气温度", dataIndex: "AirTemperature", number: 0 },
    { title: "空气湿度", dataIndex: "AirHumidity", number: 1 },
    { title: "光照", dataIndex: "Illumination", number: 2 },
    { title: "大气压力", dataIndex: "Pressure", number: 3 },
    { title: "蒸发", dataIndex: "Evaporate", number: 4 },
    { title: "风向", dataIndex: "WindDirection", number: 5 },
    { title: "风速", dataIndex: "WindSpeed", number: 6 },
    { title: "雨量", dataIndex: "Rainfall", number: 7 },
    { title: "更新时间", dataIndex: "updateTime", number: 8 }
];
export default class extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            deviceInfo,
            //数据总数
            itemCount: meteorologyHistory.data.data.itemCount,
            //列表数据源
            items: meteorologyHistory.data.data.items,
            //全部title 显示设置
            tableTitle,
            //列表title
            title: tableTitle,
    ...
    render() {
        ...
        return (
            <div className={styles.history}>
                ...
                <div className={styles.deviceInfo} title={deviceInfo.deviceId}>
